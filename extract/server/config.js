...
var config ={
	credentials: {
		...
		client_id: process.env.FORGE_CLIENT_ID || 'gqAQqMBwEMDGMMsTqn79qyCtInEWKbaX', //note: delete ID later
		client_secret: process.env.FORGE_CLIENT_SECRET || 'N493c0e8a19f547a', //delete secret later
	...
	RECAPTCHA_SECRET : process.env.RECAPTCHA_SECRET || '6LcEQFkUAAAAAOLc_cAAC7cmCZmwaEAQ1K_U9W1c',
